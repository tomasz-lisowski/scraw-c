 ...
 */
int32_t scraw_reader_search_begin(scraw_st *const ctx);
...
/**
 * @brief Get the next reader in the list of readers obtained in search. First
 * call after a call to 'search', this shall return the first reader (at index
 * 0).
 * @param ctx
